...
def test_weka_backend_sanity(tmp_path):
    WEKA_DIR = tmp_path / "weka" / "test-cache"
    ...
    try:
        ...
        config_path = tmp_path / "weka.yaml"
        config_path.write_text(
            "\n".join(
                [
                    "chunk_size: 256",
                    f'weka_path: "{WEKA_DIR}"',
                    "local_cpu: False",
        ...
        config_weka = LMCacheEngineConfig.from_file(config_path)
